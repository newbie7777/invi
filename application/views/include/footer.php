    ...
    <?php if (isset($page_title) && $page_title != 'Register'): ?>
        <footer class="footer footer--s3 footer--color-dark <?php if(settings()->enable_frontend == 0){echo "d-none";} ?>">
                            ...
                            <div class="footeritem">
                                <div class="s-btns s-btns--md s-btns--dark s-btns--rounded">
                                    <ul class="d-flex flex-row flex-wrap align-items-center">
                                        <li><a class="f" href="<?php echo prep_url($settings->facebook) ?>"><i class="fontello-facebook"></i></a></li>
                                        <li><a class="t" href="<?php echo prep_url($settings->twitter) ?>"><i class="fontello-twitter"></i></a></li>
                                        <li><a class="y" href="<?php echo prep_url($settings->linkedin) ?>"><i class="fontello-linkedin"></i></a></li>
                                        <li><a class="i" href="<?php echo prep_url($settings->instagram) ?>"><i class="fontello-instagram"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
