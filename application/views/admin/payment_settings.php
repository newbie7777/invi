<div class="content-wrapper">
  ...
  <div class="row mt-20">
    ...
    <?php if (settings()->type == 'demo'): ?>
      <div class="col-lg-8">
        <div class="card p-4 mr-2 label-light-danger">
        ...
        <div class="row <?php echo $uval ?>">
          ...
          <?php if (settings()->rpa_enable == 1): ?>
            <div class="col-sm-6">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title d-block">Razorpay <span class="pull-right"><input type="checkbox" name="razorpay_payment" value="1" <?php if($settings->razorpay_payment == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span></h3>
                </div>
          ...
          <div class="col-sm-6">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title d-block">Paystack <span class="pull-right"><input type="checkbox" name="paystack_payment" value="1" <?php if($settings->paystack_payment == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span></h3>
                </div>
