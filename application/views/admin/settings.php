      ...
      <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/settings/update') ?>" role="form" class="form-horizontal">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="row mt-20">
              <div class="col-md-8">
                <div class="tab-content box">
                    ...
                    <div class="tab-pane" id="content2" aria-hidden="false">
                      <div class="box-body">
                        ...
                        <div class="form-group mb-20">
                          <p class="smalls"><i class="fa fa-info-circle"></i> <?php echo trans('test-email-will-send-to') ?>: <strong class="text-success"><?php echo settings()->admin_email ?> </strong> </p>
                    ...
                    <div class="tab-pane" id="content6" aria-hidden="false">
                      <div class="box-body">
                        <div class="form-group m-t-20">
                            <label class="col-sm-2 control-label" for="example-input-normal"><?php echo trans('terms-of-service') ?></label>
              ...
              <!-- settings second sections -->
              <div class="col-md-4">

                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title"><?php echo trans('price-settings') ?></h3>
                  </div>

                  <div class="box-body">
                    <div class="form-group m-t-20">
                        <div class="col-sm-12">
                            <label><?php echo trans('price-format') ?></label>
                            <select class="form-control" name="num_format">
                              <option value="0" <?php if($settings->num_format == '1'){echo "selected";} ?>>$100</option>
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-sm-12">
                            <label><?php echo trans('symbol-direction') ?></label>
                            <select class="form-control" name="symbol_direction">
                              <option value="left" <?php if($settings->symbol_direction == 'left'){echo "selected";} ?>>$100 (<?php echo trans('left') ?>)</option>
                              <option value="right" <?php if($settings->symbol_direction == 'right'){echo "selected";} ?>>100$ (<?php echo trans('right') ?>)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-sm-12">
                            <label><?php echo trans('space-price-symbol') ?></label>
                            <select class="form-control" name="space_price_symbol">
                              <option value="0" <?php if($settings->space_price_symbol == '0'){echo "selected";} ?>>$100</option>
                              <option value="1" <?php if($settings->space_price_symbol == '1'){echo "selected";} ?>>$ 100</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-sm-12">
                            <label><?php echo trans('price-separator') ?></label>
                            <select class="form-control" name="price_separator">
                              <option value="0" <?php if($settings->price_separator == '0'){echo "selected";} ?>>$ 1,000.00</option>
                              <option value="1" <?php if($settings->price_separator == '1'){echo "selected";} ?>>$ 1.000,00</option>
                            </select>
                        </div>
                    </div>
                  </div>
                ...
                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title"><?php echo trans('time-zone') ?></h3>
                  </div>
                    ...
                    <div class="form-group m-t-20">
                        ...
                        <div class="col-sm-12">
                            <select class="form-control" name="trial_days">
                              <?php for ($t=0; $t < 91; $t++) { ?>
                                <option <?php if($settings->trial_days == $t){echo "selected";} ?> value="<?php echo $t; ?>"><?php echo $t; ?> <?php echo trans('days') ?></option>
                              <?php } ?>
                            </select>
