                      ...
                      <table class="table table-hover mb-0">
                          <tbody>
                              ...
                              <?php foreach ($features as $feature): ?>
                                <tr class="monthly_row <?php if($feature->id == 6){echo $uval;} ?>" style="display: <?php if($user->billing_type == 'yearly'){echo "none";} ?>">
                                ...
                                <tr class="yearly_row <?php if($feature->id == 6){echo $uval;} ?>" style="display: <?php if($user->billing_type == 'monthly'){echo "none";} ?>">
                                    <td width="30%"><?php echo trans($feature->slug); ?></td>
