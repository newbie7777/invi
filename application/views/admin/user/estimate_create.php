                              ...
                              <div class="panel-body inv">                      
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php else: ?>
                                            <input type="text" class="form-control text-right" name="title" value="<?php echo $this->business->estimate_title ?>">

                                                <input type="text" id="example-input-large" name="summary" class="form-control form-control-md text-right" value="<?php echo $this->business->estimate_summary ?>">
                                        <?php endif ?>
                                        ...
                                        <?php if (isset($page_title) && $page_title == 'Edit Estimate'): ?>
                                            ...
                                            <?php foreach ($items as $product): ?>
                                                <tr class="item-row">
                                                    ...
                                                    <td>
                                                        <textarea name="details[]" class="form-control ac-textarea" rows="1" placeholder="Enter item description"><?php echo $product->details ?></textarea> 
                                                    </td>
                                                    <td>
                              ...
                              <div class="panel-body inv">                      
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php else: ?>
                                            <textarea id="summernote" class="form-control" rows="8" name="footer_note" placeholder="<?php echo trans('invoice-footer-placeholder') ?>"><?php echo $this->business->estimate_footer_note ?></textarea>
                                        <?php endif ?>
                                    </div>
                                </div>
                              </div>
