                ...
                <div class="invoice_area mt-20">
                                  ...
                                  <div class="panel-body inv">                      
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php else: ?>
                                                <input type="text" class="form-control text-right" name="title" placeholder="<?php echo trans('invoice-titles') ?>" value="<?php echo html_escape($this->business->invoice_title) ?>">

                                                <input type="text" id="example-input-large" name="summary" class="form-control form-control-md text-right" value="<?php echo html_escape($this->business->invoice_summary) ?>">
                                            <?php endif ?>
                    ...
                    <div class="box shadow-lg">
                      ...
                      <div class="box-footer text-right">
                        ...
                        <span class="conversion_currency fs-13"> </span>
                      </div>
                    </div> 
