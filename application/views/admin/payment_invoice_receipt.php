  ...
  <div class="main-box">
    ...
    <?php if (isset($page_title) && $page_title != 'Export'): ?>
     <!--  <a href="<?php //echo base_url('readonly/export_invoice/'.$user->puid) ?>" class="btn btn-default btn-rounded mr-5 mb-20"><i class="fa fa-download"></i> <?php //echo trans('download-pdf') ?> </a> -->
      ...
      <a href="<?php echo base_url('readonly/export_invoice/'.$user->puid) ?>" data-id="invoice_<?php echo rand() ?>" class="btn btn-default btn-rounded mr-5 mb-20"><i class="fa fa-download"></i> <?php echo trans('download-pdf') ?> </a>
    <?php endif ?>
